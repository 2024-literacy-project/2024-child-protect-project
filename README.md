...
### ② 프로젝트 소개
  ...
  - **아동안전지킴이집 지도 기능**: 
    - 현재 위치 기준으로 주변 아동안전지킴이집 리스트 확인
  - **자율방범대 커뮤니티**: 
   - 아동등하교동행서비스 - 게시판보고 신청하면 인증된 기관에서 사람 배정해서 동행해주기
   - 순찰인증- 실시간x, 매일매일 동선 바꿔가면서 순찰 후에 인증하기 
  - **안전수칙 메뉴얼**: 
    - 아동 안전지킴이집에 대한 알림
    - 아동 안전지킴이집 행동수칙
...
### ③ 자율방범대 커뮤니티
- 1.아동등하교동행서비스 - 게시판보고 신청하면 인증된 기관에서 사람 배정해서 동행해주기

- 2.순찰인증- 실시간x, 매일매일 동선 바꿔가면서 순찰 후에 인증하기
